...
commands_to_test = [
    ...
    "STSDI", "STSATI", "STI", "STDICPO", "STDI", "STWBR", "STUFC"
]
...
def run_test():
    ...
    with serial.Serial(COM_PORT, BAUD_RATE, timeout=1) as ser, open(log_filename, 'w') as log_file:
        ...
        # Randomly select 10 commands and test their 3 cases (valid, invalid, multiple spaces)
        selected_commands = random.sample(commands_to_test, 10)
